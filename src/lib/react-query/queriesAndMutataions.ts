...
import { INewPost, INewUser, IUpdatePost } from '@/types/indeis'
...
export const useDeleteSavedPost = () => {
    ...
    return useMutation({
        mutationFn: ({savedRecordId, userId}: {savedRecordId: string, userId: string}) => deleteSavedPost (savedRecordId, userId),
