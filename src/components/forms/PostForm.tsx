...
import { PostValidation } from "@/lib/validation/indexer"
import { Models } from "appwrite"
import { useCreatePost, useUpdatePost } from "@/lib/react-query/queriesAndMutataions"
...
const PostForm = ({ post, action }: PostFormProps) => {
  ...
  return (
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9 w-full max-w-5xl">
      ...
      <Button type="button"
      className="shad-button_dark_4" onClick={() => navigate(-1)} >Cancel</Button>
